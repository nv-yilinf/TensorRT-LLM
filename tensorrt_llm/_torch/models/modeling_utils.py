...
from typing import Dict, Generic, List, Optional, Tuple, Type, TypeVar, Union, Any
...
class Eagle3DecoderLayer(DecoderLayer, Generic[TAttention, TConfig]):
    def __init__(
        self,
        attention_class: Type[TAttention],
        ...
        class Eagle3Attention(attention_class):
            def __init__(self, model_config: TConfig, layer_idx: int):
...
class Eagle3DraftModel(DecoderModel, Generic[TAttention, TConfig]):
    ...
    def __init__(self,
        ...
        self.midlayer = Eagle3DecoderLayer[TAttention, TConfig](attention_class, model_config, start_layer_idx)
...
class Eagle3ForCausalLM(DecoderModelForCausalLM[TModel, TConfig], Generic[TModel, TConfig]):
